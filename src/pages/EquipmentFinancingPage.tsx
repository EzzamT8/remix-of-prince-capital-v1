import { Zap, CheckCircle, ArrowRight, Clock, FileText } from 'lucide-react';
...
const EquipmentFinancingPage = () => {
  ...
  const benefits = [
    "Fast funding for equipment purchases",
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="px-4 sm:px-6 lg:px-8 py-16 pt-32">
        <div className="max-w-4xl mx-auto">
          <BackToHome currentPage="Equipment Financing" />
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-large max-w-2xl mx-auto mb-8">
              Get fast funding for equipment purchases and business infrastructure to keep your operations running smoothly.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Why choose equipment financing</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <div className="text-center bg-muted/30 rounded-2xl p-8">
            ...
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              Apply for equipment financing and get the tools your business needs to succeed.
            </p>
            <Button 
